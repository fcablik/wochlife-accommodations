...
INSERT INTO "new_SeasonalRoomPrice" ("additionalNightPrice", "id", "nightPrice", "roomId", "seasonId", "weekDivisionId") SELECT "additionalNightPrice", "id", "nightPrice", "roomId", "seasonId", "weekDivisionId" FROM "SeasonalRoomPrice";
