/*
  ...
  - Added the required column `additionalGuestNightPrice` to the `Reservation` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Reservation" (
    ...
    "additionalGuestNightPrice" INTEGER NOT NULL,
