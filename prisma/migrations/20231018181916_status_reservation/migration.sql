...
INSERT INTO "new_Reservation" ("additionalGuestNightPrice", "createdAt", "createdAtString", "email", "id", "message", "name", "nightPrice", "numberOfGuests", "numberOfNights", "reservationDateFrom", "reservationDateTo", "reservationNumber", "roomId", "totalPrice", "updatedAt") SELECT "additionalGuestNightPrice", "createdAt", "createdAtString", "email", "id", "message", "name", "nightPrice", "numberOfGuests", "numberOfNights", "reservationDateFrom", "reservationDateTo", "reservationNumber", "roomId", "totalPrice", "updatedAt" FROM "Reservation";
