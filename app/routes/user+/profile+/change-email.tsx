...
export async function handleVerification({
	...
	void sendEmail({
		...
		subject: 'wochdev hotels email changed',
...
export async function action({ request }: DataFunctionArgs) {
	...
	const response = await sendEmail({
		...
		subject: `wochdev hotels Email Change Verification`,
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>wochdev hotels Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
export function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your wochdev hotels email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your wochdev hotels email has been
						changed.
					</E.Text>
				</p>
				<p>
